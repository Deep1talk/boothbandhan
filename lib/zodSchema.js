...
export const zodLeaderGreetingProfileSchema = z.object({
  ...
  whatsappNumber: z
    ...
    .optional()
    .refine(
      (value) => value === undefined || value === "" || /^\d{10,10}$/.test(value),
  ...
  posterPhotoScale: z.coerce
    .number()
    .min(0.2, "Photo zoom must be at least 0.2")
  ...
  posterPhotoOffsetY: z.coerce
    ...
    .max(360, "Vertical crop offset is too large"),
});
...
const optionalEnumField = (options) => z
  .string()
  .trim()
  .optional()
  .refine((value) => value === undefined || value === "" || options.includes(value), {
    message: "Please select a valid option",
  });

const optionalNumberField = (requiredMessage) => z.preprocess(
  (value) => (value === "" || value === null || value === undefined ? undefined : value),
  z.coerce.number({ message: requiredMessage }).optional()
);
...
export const zodCreateLeaderSchema = z.object({
  ...
  politicalPosition: z
    .string()
    .optional(),
  hasContestedElection: optionalEnumField(YES_NO_OPTIONS),
  experienceYears: optionalNumberField("Experience is required").refine(
  ...
  mainSupportBase: z
    .string()
    .optional(),
  activeWorkerCount: optionalNumberField("Active worker count is required").refine(
    (value) => value === undefined || value >= 0,
    "Active worker count cannot be negative"
  ),
  ...
  topIssue3: z
    .string()
    .optional(),
  socialWorkerAshaName: z
    .string()
    .trim()
    .min(1, "Asha name is required"),
  socialWorkerAshaPhone: z
    .string()
    .trim()
    .min(1, "Asha phone number is required")
    .regex(/^\d{10,10}$/, "Enter a valid 10-digit Asha phone number"),
  socialWorkerJeevikaDidiName: z
    .string()
    .trim()
    .min(1, "Jeevika didi name is required"),
  socialWorkerJeevikaDidiPhone: z
    .string()
    .trim()
    .min(1, "Jeevika didi phone number is required")
    .regex(/^\d{10,10}$/, "Enter a valid 10-digit Jeevika didi phone number"),
  socialWorkerAaganBadiSevikaName: z
    .string()
    .trim()
    .min(1, "Aagan Badi sevika name is required"),
  socialWorkerAaganBadiSevikaPhone: z
    .string()
    .trim()
    .min(1, "Aagan Badi sevika phone number is required")
    .regex(/^\d{10,10}$/, "Enter a valid 10-digit Aagan Badi sevika phone number"),
