...
export function normalizePosterProfile(user) {
  ...
  const posterTemplateSettings = user.posterTemplateSettings instanceof Map
    ? Object.fromEntries(user.posterTemplateSettings.entries())
    : user.posterTemplateSettings || {};
  ...
  return {
    ...
    selectedGreetingTemplateId: user.selectedGreetingTemplateId || "",
